...
abstract Stream(Stream_t) from Stream_t to Stream_t {
	...
	public inline function shutdown(req:Shutdown, cb:cpp.Callable<cpp.Star<UvShutdown>->Int->Void>)
		return Uv.shutdown(req, this, cb);

	public inline function listen(backlog:Int, cb:cpp.Callable<cpp.Star<UvStream>->Int->Void>)
		return Uv.listen(this, backlog, cb);

	public inline function accept(client:Stream)
		return Uv.accept(this, client);

	public inline function readStart(alloc_cb:cpp.Callable<cpp.Star<UvHandle>->cpp.SizeT->cpp.Star<Buf_t>->Void>,
			read_cb:cpp.Callable<cpp.Star<UvStream>->SSizeT->cpp.ConstStar<Buf_t>->Void>)
		return Uv.read_start(this, alloc_cb, read_cb);

	public inline function readStop()
		return Uv.read_stop(this);

	public inline function write(req:Write, bufs:Buf, nbufs:UInt, cb:cpp.Callable<cpp.Star<UvWrite>->Int->Void>)
